...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edPassword = findViewById(R.id.editTextLTBContact);
        edConfirmPassword = findViewById(R.id.editTextLTBPinCode);
        btn = findViewById(R.id.btnBookAppointment);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(edUsername.length()==0||email.length()==0||confirm.length()==0||password.length()==0){
                    ...
                    if(password.compareTo(confirm)==0){
                        if (isValid(password)){
                            ...
                            Toast.makeText(getApplicationContext(), "password must contain 8 char and havi digit and special symbols ", Toast.LENGTH_SHORT).show();
                        }
