...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed3 = findViewById(R.id.editTextLTBContact);
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences sharedPreferences = getSharedPreferences("shered_perfs", Context.MODE_PRIVATE);
                ...
                if (db.checkAppointmentExists(username,title+"=>"+fullname,address,contact,dateButton.getText().toString(),timeButton.getText().toString())==1){
                    Toast.makeText(getApplicationContext(), "Appointment is already booked", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    Toast.makeText(getApplicationContext(), "your Appointment is done sucessfuly", Toast.LENGTH_SHORT).show();
